...
#### Create L1 CN data #### - @MORIAH: check that the below code is no longer needed (i.e., that it is incorporated above; if so, delete it)
...
write.csv(CN_final, file.path(L1_dir, "./CN/CN_L1.csv"), row.names=F)

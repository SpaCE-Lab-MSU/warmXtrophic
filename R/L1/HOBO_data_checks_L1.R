...
KBS_2019_3_10 <- KBS %>%
        ...
        gather(key = "treatment", value = "temp", -year, -julian, -Date_Time, -sensor) %>%
        filter(sensor == 3)
ggplot(KBS_2019_3_10, aes(x=julian, y=temp, group=treatment, color=treatment)) +
        geom_point() +
        scale_color_manual(name="Treatment",
                           values = c("#a6bddb", "#fb6a4a"),
                           labels=c("Ambient 10cm","Warmed 10cm"))
...
KBS_2020_3_10 <- KBS %>%
        ...
        gather(key = "treatment", value = "temp", -year, -julian, -Date_Time, -sensor) %>%
        filter(sensor == 3)
ggplot(KBS_2020_3_10, aes(x=julian, y=temp, group=treatment, color=treatment)) +
        geom_point() +
        scale_color_manual(name="Treatment",
                           values = c("#a6bddb", "#fb6a4a"),
                           labels=c("Ambient 10cm","Warmed 10cm"))
...
KBS_2018_3_stemp <- KBS %>%
        ...
        gather(key = "treatment", value = "temp", -year, -julian, -Date_Time, -sensor) %>%
        filter(sensor == 3)
ggplot(KBS_2018_3_stemp, aes(x=julian, y=temp, group=treatment, color=treatment)) +
        geom_point() +
        scale_color_manual(name="Treatment",
                           values = c("#a6bddb", "#fb6a4a"),
                           labels=c("Ambient 10cm","Warmed 10cm"))

...
contrast(emmeans(c.hyp.k2, ~treatment*insecticide*year), "pairwise", simple = "each", combine = F, adjust = "mvt")
# making a table
...
summary(n.hyp.k2)
contrast(emmeans(n.hyp.k2, ~treatment*insecticide*year), "pairwise", simple = "each", combine = F, adjust = "mvt")
# table
...
contrast(emmeans(n.hyp.u2, ~treatment*insecticide*year), "pairwise", simple = "each", combine = F, adjust = "mvt")
# table

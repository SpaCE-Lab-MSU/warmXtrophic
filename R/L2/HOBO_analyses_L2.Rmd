...
KBS_season1 <- KBS_season[!(KBS_season$sensor == 1 & KBS_season$year =="2021" ),] 
...
KBS_season_10cm <- KBS_season1 %>%
  ...
  filter(hour > "06") %>%
  filter(hour < "20") %>%
  dplyr::select(Date_Time, year, month, hour, XU_warmed_air_10cm, XU_ambient_air_10cm)
...
UMBS_season1 <- UMBS_season1[!(UMBS_season1$sensor == 1 & UMBS_season1$year =="2021" & UMBS_season1$month == "07"),] 
UMBS_season1 <- UMBS_season1[!(UMBS_season1$sensor == 1 & UMBS_season1$year =="2021" & UMBS_season1$month == "08"),]
UMBS_season1 <- UMBS_season1[!(UMBS_season1$sensor == 1 & UMBS_season1$year =="2021" & UMBS_season1$month == "09"),]
UMBS_season1 <- UMBS_season1[!(UMBS_season1$sensor == 1 & UMBS_season1$year =="2021" & UMBS_season1$month == "10"),]
UMBS_season1 <- UMBS_season1[!(UMBS_season1$sensor == 1 & UMBS_season1$year =="2021" & UMBS_season1$month == "11"),]

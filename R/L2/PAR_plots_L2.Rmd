...
KBS_line <- ggplot(KBS_gather, aes(x = year, y = average_par, group=full_treat, color = full_treat, linetype=full_treat, fill=full_treat)) +
        geom_pointrange(aes(ymin=average_par-se, ymax=average_par+se), linetype="solid",color="black",pch=21,size=0.5) +
...
UMBS_line <- ggplot(UMBS_gather, aes(x = year, y = average_par, group=full_treat, color = full_treat, linetype=full_treat, fill=full_treat)) +
        geom_pointrange(aes(ymin=average_par-se, ymax=average_par+se), linetype="solid",color="black",pch=21,size=0.5) +
        #geom_errorbar(aes(ymin=average_par-se, ymax=average_par+se), width=.1,color="black",linetype="solid") +
        geom_line(size = 0.75) +
        #geom_point(size = 2) +
...
annotate_figure(line_comb,
                left = text_grob("PAR (µmol m-2s-1)", color = "black", rot = 90, size=17),

...
anova(m.hyp.k)
# table
kable(anova(m.hyp.k)) %>% kableExtra::kable_styling()
summary(m.hyp.k)
(-1940)^3 # -7301384000
(-1940 + 0.1491)^3 # -7299700671
-7299700671 + 7301384000 # 1683329
contrast(emmeans(m.hyp.k, ~state*insecticide), "pairwise", simple = "each", combine = F, adjust = "mvt")
...
anova(m.hyp.u)
contrast(emmeans(m.hyp.u, ~state+insecticide), "pairwise", simple = "each", combine = F, adjust = "mvt")
# table
kable(anova(m.hyp.u)) %>% kableExtra::kable_styling()
# hypothesized model - with species

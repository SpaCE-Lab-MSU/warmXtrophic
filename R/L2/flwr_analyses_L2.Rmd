...
# Data exploration for median Julian date of flowering at the PLOT LEVEL
```{r}
...
```{r, eval=F}
umbs_flwr_plot$log_julian_median <- log(umbs_flwr_plot$julian_median)
umbs_flwr_plot$log_julianMedian_centered = umbs_flwr_plot$log_julian_median - mean(umbs_flwr_plot$log_julian_median)
hist(umbs_flwr_plot$log_julianMedian_centered)
```

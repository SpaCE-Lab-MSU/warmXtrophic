...
shapiro.test(kbs_flwr_plot$flwr_duration_scaled) # pvalue is almost > 0.05 so we do not reject the null hypothesis that the data is normal (aka close to normally distributed)

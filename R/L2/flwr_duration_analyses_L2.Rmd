...
modtest1 <- lmer(flwr_duration_scaled ~ mean_temp + (1|plot), kbs_flwr_plot, REML=FALSE)
modtest2 <- lmer(flwr_duration_scaled ~ GDD_cumulative + (1|plot), kbs_flwr_plot, REML=FALSE)

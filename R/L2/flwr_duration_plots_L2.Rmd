...
flwr_avg_duration_kbs_plot <- ggplot(flwr_avg_duration_kbs) +
                geom_linerange(aes(ymin = avg_first_flwr, ymax = avg_last_flwr,
                   ...
                   size = 2, 
                   position = position_dodge(width = 0.5)) +
        labs(title = "KBS", x = "Year", y = "Julian Date") +
        scale_color_manual(values=c('A0'='blue', 'AI'='deepskyblue', 'W0'='red', 'WI'='red4'),
                           name="Treatment",
                           labels = c("A0" = "Ambient",
                              "AI" = "Ambient +\n Reduced Herbivory",
                              "W0" = "Warmed",
                              "WI" = "Warmed +\n Reduced Herbivory"))
flwr_avg_duration_kbs_plot
# 2021 data from kbs looks like it should be deleted? Ask Mark about this. Maybe data wasn't taking as frequently as other years + 2015 data
...
flwr_avg_duration_umbs_plot <- ggplot(flwr_avg_duration_umbs) +
                geom_linerange(aes(ymin = avg_first_flwr, ymax = avg_last_flwr,
                   ...
                   size = 2, 
                   position = position_dodge(width = 0.5)) +
        labs(title = "UMBS", x = "Year", y = "Julian Date") +
        scale_color_manual(values=c('A0'='blue', 'AI'='deepskyblue', 'W0'='red', 'WI'='red4'),
                           name="Treatment",
                           labels = c("A0" = "Ambient",
                              "AI" = "Ambient +\n Reduced Herbivory",
...
flwr_dur <- ggarrange(flwr_avg_duration_kbs_plot, flwr_avg_duration_umbs_plot, 
                      nrow = 2, 
                      common.legend = TRUE,
                      legend = "bottom")

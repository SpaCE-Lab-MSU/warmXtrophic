...
mod7a <- lmer(spp_half_cover_date ~ state + species + factor(year_factor) + (1|plot), green_kbs, REML=FALSE)
...
mod2p <- lmer(plot_half_cover_date ~ state + factor(year_factor) + (1|plot), green_kbsp, REML=FALSE)

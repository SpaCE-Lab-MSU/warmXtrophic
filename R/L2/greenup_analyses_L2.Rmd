...
# note: we decided to use GDD and mean temp for analyses based on their correlation w/ green-up
# those correlation figs can be found in the greenup_plots_L2.R script

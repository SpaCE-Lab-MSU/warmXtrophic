...
AICctab(mod1p, mod2p, mod3p, mod4p, mod5p, mod6p, mod7p, mod8p, mod9p, mod10p, mod11p, weights=T) # 5p or 6p
anova(mod5p, mod6p) #5p - used this model in results section

summary(mod5p)
anova(mod5p)
emmeans(mod5p, list(pairwise ~ state+year_factor), adjust = "tukey")
mod5p.emm <- emmeans(mod5p, ~ state + year_factor) # why are the comparisons the same for each year?
contrast(mod5p.emm, "consec", simple = "each", combine = F, adjust = "mvt")

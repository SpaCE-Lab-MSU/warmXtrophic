...
DATA INPUT: Clean & plot greenup csv from the shared Google drive  
...
gr_plot <- read.csv(file.path(L1_dir, "greenup/final_greenup_plot_L1.csv"))
gr_species <- read.csv(file.path(L1_dir, "greenup/final_greenup_species_L1.csv"))

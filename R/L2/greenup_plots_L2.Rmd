...
## Bar plot for greenup for KBS and UMBS - Half cover date
```{r, echo = F}
...
## Box plot for greenup for KBS and UMBS - Half cover date
```{r, echo = F}
...
## Bar plot for greenup for KBS and UMBS - Min cover date
```{r, echo = F}
greenup_plot_all <- function(loc) { 
...
## Box plot for greenup for KBS and UMBS - Min cover date
```{r, echo = F}
greenup_plot_box <- function(loc) { 
  greenup_spp <- subset(gr_species, site == loc)

...
```{r}
# KBS origin plot level
modfull_o <- lmer(relabun ~ state*origin + insecticide*origin + year_factor*origin + (1|plot), kbs_origin_plot, REML=F)
...
modfull_o <- lmer(relabun ~ state*origin + insecticide*origin + year_factor*origin + (1|plot), kbs_origin_plot, REML=F)
mod1p_o <- lmer(relabun ~ state*origin + insecticide*origin + year_factor + origin + (1|plot), kbs_origin_plot, REML=F)
mod2p_o <- lmer(relabun ~ state + insecticide*origin + year_factor + origin + (1|plot), kbs_origin_plot, REML=F)
mod3p_o <- lmer(relabun ~ state + insecticide + year_factor + origin + (1|plot), kbs_origin_plot, REML=F)
mod4p_o <- lmer(relabun ~ state + year_factor + origin + (1|plot), kbs_origin_plot, REML=F)
mod5p_o <- lmer(relabun ~ state + origin + (1|plot), kbs_origin_plot, REML=F)
mod6p_o <- lmer(relabun ~ state * origin + (1|plot), kbs_origin_plot, REML=F)
mod7p_o <- lmer(relabun ~ state*origin + insecticide*origin + (1|plot), kbs_origin_plot, REML=F) # hypothesis?
...
# KBS State and year model
fit_plot_stateyear_kbs <- lm(relabun ~ state + growth_habit, data = kbs_growth_plot)
outlierTest(fit_plot_stateyear_kbs) # no outliers 
qqPlot(fit_plot_stateyear_kbs, main="QQ Plot") 
hist(fit_plot_stateyear_kbs$residuals)
leveragePlots(fit_plot_stateyear_kbs)
...
fit3 <- lm(relabun ~ state * growth_habit, data = kbs_growth_plot)
...
modfull_g <- lmer(relabun ~ state*growth_habit + insecticide*growth_habit + year_factor*growth_habit + (1|plot), kbs_growth_plot, REML = FALSE)
...
```{r}
modfull_g <- lmer(relabun ~ state*growth_habit + insecticide*growth_habit + year_factor*growth_habit + (1|plot), kbs_growth_plot, REML=F)
anova(modfull_g) # significant interaction term with state and growth_habit


mod1p_g <- lmer(relabun ~ state*growth_habit + insecticide*growth_habit + year_factor + growth_habit + (1|plot), kbs_growth_plot, REML=F)
anova(mod1p_g)
anova(mod1p_g, modfull_g)

mod2p_g <- lmer(relabun ~ state*growth_habit + insecticide + year_factor*growth_habit + growth_habit + (1|plot), kbs_growth_plot, REML=F)
anova(mod2p_g)

mod3p_g <- lmer(relabun ~ state*growth_habit + insecticide + year_factor + growth_habit + (1|plot), kbs_growth_plot, REML=F)
anova(mod3p_g)

mod4p_g <- lmer(relabun ~ state + year_factor + insecticide + growth_habit + (1|plot), kbs_growth_plot, REML=F)
mod5p_g <- lmer(relabun ~ state + year_factor + growth_habit + (1|plot), kbs_growth_plot, REML=F) 
anova(mod4p_g, mod5p_g) # including insecticide in the model does not improve it

mod6p_g <- lmer(relabun ~ state + growth_habit + (1|plot), kbs_growth_plot, REML=F)
mod7p_g <- lmer(relabun ~ state*growth_habit + (1|plot), kbs_growth_plot, REML=F)
mod8p_g <- lmer(relabun ~ state*growth_habit + insecticide*growth_habit + (1|plot), kbs_growth_plot, REML=F) #hypothesis?
...
```{r}
# UMBS origin plot level
modfull_o_u <- lmer(relabun ~ state*origin + insecticide*origin+ year_factor*origin + (1|plot), umbs_origin_plot, REML = FALSE)
...
modfull_g_u <- lmer(relabun ~ state*growth_habit + insecticide*growth_habit + year_factor*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
...
mod1p_g_u <- lmer(relabun ~ state*growth_habit + insecticide + growth_habit + year_factor*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod1p_g_u) # significant interaction term with growth habit and year

mod2p_g_u <- lmer(relabun ~ state + insecticide + growth_habit + year_factor*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod2p_g_u)

mod3p_g_u <- lmer(relabun ~ state + growth_habit + year_factor*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod3p_g_u)

mod3p_g_u <- lmer(relabun ~ state + growth_habit + year_factor*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod3p_g_u)
mod3p_g_u <- lmer(relabun ~ state + insecticide + year_factor + growth_habit + (1|plot), umbs_growth_plot, REML=F)
mod4p_g_u <- lmer(relabun ~ state + growth_habit + (1|plot), umbs_growth_plot, REML=F)
mod5p_g_u <- lmer(relabun ~ state * growth_habit + (1|plot), umbs_growth_plot, REML=F)
mod6p_g_u <- lmer(relabun ~ state*growth_habit + insecticide*growth_habit + (1|plot), umbs_growth_plot, REML=F) # hypothesis?

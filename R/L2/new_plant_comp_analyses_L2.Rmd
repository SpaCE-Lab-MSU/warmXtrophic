...
mod1p_o_u <- lmer(relabun ~ state*origin + insecticide + origin + year_factor*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod1p_o_u)
anova(modfull_o_u, mod1p_o_u)

mod2p_o_u <- lmer(relabun ~ state + insecticide + origin + year_factor*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod2p_o_u)

mod3p_o_u <- lmer(relabun ~ state + origin + insecticide + year_factor + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod3p_o_u)
mod4p_o_u <- lmer(relabun ~ state + origin + year_factor*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod4p_o_u)
mod5p_o_u <- lmer(relabun ~ state + origin + year_factor + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod5p_o_u)
anova(mod4p_o_u, mod5p_o_u) # mod3
mod6p_o_u <- lmer(relabun ~ state + origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod6p_o_u)
mod7p_o_u <- lmer(relabun ~ state*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod7p_o_u)

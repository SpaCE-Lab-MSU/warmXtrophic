...
mod18p_o <- lmer(relabun ~ state * year_factor * insecticide * origin + (1|plot), kbs_origin_plot, REML=FALSE)
```
...
7.09411 +  0.29494*0 # 1204.85 warmed
7.09411 +  0.29494*1 # 1618.168 ambient
# effect:
1618.168 - 1204.85 # warmed plots had 413.318 more cover than ambient
# this might be flipped?

# code to get table information for manuscript
table <- anova(mod5p_o, mod9p_o)
kable(table) %>% kableExtra::kable_styling()
AICctab(mod5p_o, mod9p_o, weights=T)
```

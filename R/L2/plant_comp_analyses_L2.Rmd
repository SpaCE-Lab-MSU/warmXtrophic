...
# making a table
kable(anova(mod_exotic_u), digits = 2) %>% kableExtra::kable_styling()
...
# making a table
kable(anova(mod_forb_k), digits = 2) %>% kableExtra::kable_styling()
...
# making a table
kable(anova(mod_graminoid_k), digits = 2) %>% kableExtra::kable_styling()

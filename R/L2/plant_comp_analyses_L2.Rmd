...
# comparisons
contrast.k1 <- contrast(emmeans(mod_k_full, ~state*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt")
...
# comparisons
contrast.k2 <- contrast(emmeans(mod_k_full, ~insecticide*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt")
...
# calculating effect size of reduced herbivory in 2021 - accounting for log transformation
exp((2.763627) +  (-0.3286)*0) # 15.85725 
exp((2.763627) +  (-0.3286)*1) # 11.41613
# effect:
16.07622 - 11.41613 # 4.66009
...
# comparisons
contrast.k <- contrast(emmeans(mod_native_k, ~state*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt")
...
# comparison 1
contrast1 <- contrast(emmeans(mod_exotic_k, ~state*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt")
...
# comparison 2
contrast2 <- contrast(emmeans(mod_exotic_k, ~insecticide*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt")

...
# effect:
16.07622 - 15.85725 # effect of warming - warmed plots had 0.21897 or 0.22 times the percent cover than ambient plots


# comparisons
contrast.k1 <- contrast(emmeans(mod_k_full, ~state*year_factor), "revpairwise", simple = "each", combine = F, adjust = "mvt", type = "response") # revpairwise reverses the comparisons from ambient/warmed to warmed/ambient
# KD: back transforming ratio (https://www.reddit.com/r/statistics/comments/t6ph7o/comment/hzl704x/)
# warmed plots had 1.6 times the cover of ambient in 2021
...
# comparison
contrast <- contrast(emmeans(mod_forb_k, ~state*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt", response = "type")
...
# comparison 1
contrast1 <- contrast(emmeans(mod_graminoid_k, ~state*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt", response = "type")

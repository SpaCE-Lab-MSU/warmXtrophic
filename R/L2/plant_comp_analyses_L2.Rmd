...
```{r}
### KBS ###
hist(kbs_comp_plot$avg_relative_abundance) #skewed right
qqnorm(kbs_comp_plot$avg_relative_abundance)
shapiro.test(kbs_comp_plot$avg_relative_abundance) # pvalue is < 0.05 so we reject the null hypothesis that the data is normal (aka not normally distributed) 

# Exploring distributions:
descdist(kbs_comp_plot$avg_relative_abundance, discrete = FALSE)
...
fit_plot_state_kbs <- lm(log(avg_relative_abundance) ~ state, data = kbs_comp_plot)
...
fit_plot_stateyear_kbs <- lm(log(avg_relative_abundance) ~ state + year_factor, data = kbs_comp_plot)
...
fit3 <- lm(log(avg_relative_abundance) ~ state * year_factor, data = kbs_comp_plot)
...
```{r}
# KBS PLOT LEVEL
modfull <- lmer(log(avg_relative_abundance) ~ state*year_factor + insecticide*year_factor + (1|plot), kbs_comp_plot, REML = FALSE)
...
year.mod.test1 <- lmer(log(avg_relative_abundance) ~ state + year_factor + (1|plot), kbs_comp_plot, REML=FALSE)
year.mod.test2 <- lmer(log(avg_relative_abundance) ~ state + as.factor(year_factor) + (1|plot), kbs_comp_plot, REML=FALSE)
anova(year.mod.test1, year.mod.test2) #year.mod.test2

# plot-level models 
modfull <- lmer(log(avg_relative_abundance) ~ state*as.factor(year_factor) + insecticide*year_factor + (1|plot), kbs_comp_plot, REML=F)
mod1p <- lmer(log(avg_relative_abundance) ~ state + (1|plot), kbs_comp_plot, REML=FALSE)
mod2p <- lmer(log(avg_relative_abundance) ~ insecticide + (1|plot), kbs_comp_plot, REML=FALSE)
mod3p <- lmer(log(avg_relative_abundance) ~ insecticide + state + (1|plot), kbs_comp_plot, REML=FALSE)
mod4p <- lmer(log(avg_relative_abundance) ~ insecticide * state + (1|plot), kbs_comp_plot, REML=FALSE)
mod5p <- lmer(log(avg_relative_abundance) ~ state + as.factor(year_factor) + (1|plot), kbs_comp_plot, REML=FALSE)
mod6p <- lmer(log(avg_relative_abundance) ~ state + as.factor(year_factor) + insecticide + (1|plot), kbs_comp_plot, REML=FALSE)
mod7p <- lmer(log(avg_relative_abundance) ~ state * as.factor(year_factor) + (1|plot), kbs_comp_plot, REML=FALSE)
mod8p <- lmer(log(avg_relative_abundance) ~ state * as.factor(year_factor) + insecticide + (1|plot), kbs_comp_plot, REML=FALSE)
mod9p <- lmer(log(avg_relative_abundance) ~ state * insecticide + as.factor(year_factor) + (1|plot), kbs_comp_plot, REML=FALSE) #hypothesized model
mod10p <- lmer(log(avg_relative_abundance) ~ state + insecticide * as.factor(year_factor) + (1|plot), kbs_comp_plot, REML=FALSE)
mod11p <- lmer(log(avg_relative_abundance) ~ state * as.factor(year_factor) * insecticide + (1|plot), kbs_comp_plot, REML=FALSE)
...
exp((-2.02006) +  (-0.18808)*0) # 0.1326475 warmed
exp((-2.02006) +  (-0.18808)*1) # 0.1099049 ambient
# effect:
0.1099049 - 0.1326475 # ambient plots had 0.0227426 less relative abundance than warmed plots

# code to get table information for manuscript
table <- anova(mod5p, mod9p)
kable(table) %>% kableExtra::kable_styling()
AICctab(mod5p, mod9p, weights=T)
```
...
shapiro.test(kbs_origin_plot$avg_relative_abundance) # pvalue is > 0.05 so we can reject the null hypothesis that the data is normal (aka normally distributed) 
...
fit3 <- lm(avg_relative_abundance ~ state * year_factor, data = kbs_origin_plot)
...
```{r}
# KBS origin plot level
modfull_o <- lmer(avg_relative_abundance ~ state*origin + insecticide*origin + factor(year_factor)*origin + (1|plot), kbs_origin_plot, REML=F)
...
```{r}
# modfull_cont <- lmer(relabun ~ state*origin + insecticide*origin + as.numeric(year_factor)*origin + (1|plot), kbs_origin_plot, REML=F)
# year should be continuous not a factor
# need to plot final model selected - interpreting the model - reduced herbivory = more relative abundance
modfull_o <- lmer(avg_relative_abundance ~ state*origin + insecticide*origin + as.factor(year_factor)*origin + (1|plot), kbs_origin_plot, REML=F)
mod1p_o <- lmer(avg_relative_abundance ~ state*origin + insecticide*origin + as.factor(year_factor) + origin + (1|plot), kbs_origin_plot, REML=F)
mod2p_o <- lmer(avg_relative_abundance ~ state + insecticide*origin + as.factor(year_factor) + origin + (1|plot), kbs_origin_plot, REML=F)
mod3p_o <- lmer(avg_relative_abundance ~ state + insecticide + as.factor(year_factor) + origin + (1|plot), kbs_origin_plot, REML=F)
mod4p_o <- lmer(avg_relative_abundance ~ state + as.factor(year_factor) + origin + (1|plot), kbs_origin_plot, REML=F)
mod5p_o <- lmer(avg_relative_abundance ~ state + origin + (1|plot), kbs_origin_plot, REML=F)
mod6p_o <- lmer(avg_relative_abundance ~ state * origin + (1|plot), kbs_origin_plot, REML=F)
mod7p_o <- lmer(avg_relative_abundance ~ state*origin + insecticide*origin + (1|plot), kbs_origin_plot, REML=F) # hypothesis?
...
# code to get table information for manuscript
table <- anova(mod2p_o, mod9p_o)
kable(table) %>% kableExtra::kable_styling()
AICctab(mod2p_o, mod9p_o, weights=T)
```
...
fit3 <- lm(avg_relative_abundance ~ state * growth_habit, data = kbs_growth_plot)
interact_plot(fit3, pred = growth_habit, modx = state) # this looks very strange to me
```

Mixed Effects Model
```{r}
# KBS growth habit plot level
modfull_g <- lmer(avg_relative_abundance ~ state*growth_habit + insecticide*growth_habit + year_factor*growth_habit + (1|plot), kbs_growth_plot, REML = FALSE)
...
# code to get table information for manuscript
table <- anova(mod7p_g, mod8p_g)
kable(table) %>% kableExtra::kable_styling()
AICctab(mod7p_g, mod8p_g, weights=T)
```
...
```{r}
### UMBS ###
hist(umbs_comp_plot$avg_relative_abundance)
qqnorm(umbs_comp_plot$avg_relative_abundance)
shapiro.test(umbs_comp_plot$avg_relative_abundance) # pvalue is < 0.05 so we reject the null hypothesis that the data is normal (aka not normally distributed) 

# Exploring distributions:
descdist(umbs_comp_plot$avg_relative_abundance, discrete = FALSE)

# Gamma distribution 
fit.gamma <- fitdist(umbs_comp_plot$avg_relative_abundance, "gamma")
plot(fit.gamma)

# Weibull distribution
fit.weibull  <- fitdist(umbs_comp_plot$avg_relative_abundance, "weibull")
plot(fit.weibull)

# Lognormal distribution 
fit.ln <- fitdist(umbs_comp_plot$avg_relative_abundance, "lnorm")
plot(fit.ln)
...
fit_plot_state_umbs <- lm(log(avg_relative_abundance) ~ state, data = umbs_comp_plot)
...
fit_plot_stateyear_umbs <- lm(log(avg_relative_abundance) ~ state + year_factor, data = umbs_comp_plot)
...
fit3 <- lm(log(avg_relative_abundance) ~ state * year_factor, data = umbs_comp_plot)
interact_plot(fit3, pred = year_factor, modx = state) # this looks very strange to me
```
...
```{r}
# UMBS PLOT LEVEL
modfullu <- lmer(log(avg_relative_abundance) ~ state*year_factor + insecticide*year_factor + (1|plot), umbs_comp_plot, REML = FALSE)
...
```{r}
# plot-level models 
modfullu <- lmer(log(avg_relative_abundance) ~ state*as.factor(year_factor) + insecticide*year_factor + (1|plot), umbs_comp_plot, REML=F)
mod1pu <- lmer(log(avg_relative_abundance) ~ state + (1|plot), umbs_comp_plot, REML=FALSE)
mod2pu <- lmer(log(avg_relative_abundance) ~ insecticide + (1|plot), umbs_comp_plot, REML=FALSE)
mod3pu <- lmer(log(avg_relative_abundance) ~ insecticide + state + (1|plot), umbs_comp_plot, REML=FALSE)
mod4pu <- lmer(log(avg_relative_abundance) ~ insecticide * state + (1|plot), umbs_comp_plot, REML=FALSE)
mod5pu <- lmer(log(avg_relative_abundance) ~ state + as.factor(year_factor) + (1|plot), umbs_comp_plot, REML=FALSE)
mod6pu <- lmer(log(avg_relative_abundance) ~ state + as.factor(year_factor) + insecticide + (1|plot), umbs_comp_plot, REML=FALSE)
mod7pu <- lmer(log(avg_relative_abundance) ~ state * as.factor(year_factor) + (1|plot), umbs_comp_plot, REML=FALSE)
mod8pu <- lmer(log(avg_relative_abundance) ~ state * as.factor(year_factor) + insecticide + (1|plot), umbs_comp_plot, REML=FALSE)
mod9pu <- lmer(log(avg_relative_abundance) ~ state * insecticide + as.factor(year_factor) + (1|plot), umbs_comp_plot, REML=FALSE)
mod10pu <- lmer(log(avg_relative_abundance) ~ state + insecticide * as.factor(year_factor) + (1|plot), umbs_comp_plot, REML=FALSE)
mod11pu <- lmer(log(avg_relative_abundance) ~ state * as.factor(year_factor) * insecticide + (1|plot), umbs_comp_plot, REML=FALSE)
...
fit3 <- lm(avg_relative_abundance ~ state * year_factor, data = umbs_origin_plot)
interact_plot(fit3, pred = year_factor, modx = state) # this looks very strange to me
```
...
```{r}
modfull_o_u <- lmer(avg_relative_abundance ~ state*origin + insecticide*origin + as.factor(year_factor)*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(modfull_o_u) # significant interaction term btw year and origin

mod1p_o_u <- lmer(avg_relative_abundance ~ state*origin + insecticide + origin + as.factor(year_factor)*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod1p_o_u)
anova(modfull_o_u, mod1p_o_u)

mod2p_o_u <- lmer(avg_relative_abundance ~ state + insecticide + origin + as.factor(year_factor)r*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod2p_o_u)

mod3p_o_u <- lmer(avg_relative_abundance ~ state + origin + insecticide + as.factor(year_factor) + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod3p_o_u)
mod4p_o_u <- lmer(avg_relative_abundance ~ state + origin + as.factor(year_factor)*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod4p_o_u)
mod5p_o_u <- lmer(avg_relative_abundance ~ state + origin + as.factor(year_factor) + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod5p_o_u)
anova(mod4p_o_u, mod5p_o_u) # mod3
mod6p_o_u <- lmer(avg_relative_abundance ~ state + origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod6p_o_u)
mod7p_o_u <- lmer(avg_relative_abundance ~ state*origin + (1|plot), umbs_origin_plot, REML = FALSE)
anova(mod7p_o_u)

AICtab(modfull_o_u, mod1p_o_u, mod2p_o_u, mod3p_o_u, mod4p_o_u, mod5p_o_u, mod6p_o_u, mod7p_o_u, weights=T)
anova(mod4p_o_u, mod2p_o_u)
AICctab(mod4p_o_u, mod2p_o_u, weights=T) #mod4p
anova(mod4p_o_u)
summary(mod4p_o_u)
emmeans(mod4p_o_u, list(pairwise ~ state + year_factor), adjust = "tukey")
```
...
fit3 <- lm(avg_relative_abundance ~ state * year_factor, data = umbs_growth_plot)
interact_plot(fit3, pred = year_factor, modx = state) # this looks very strange to me
```
...
modfull_g_u <- lmer(avg_relative_abundance ~ state*growth_habit + insecticide*growth_habit + year_factor*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
...
modfull_g_u <- lmer(avg_relative_abundance ~ state*growth_habit + insecticide*growth_habit + as.factor(year_factor)*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(modfull_g_u) # significant interaction term with growth habit and year
mod1p_g_u <- lmer(avg_relative_abundance ~ state*growth_habit + insecticide + growth_habit + as.factor(year_factor)*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod1p_g_u) # significant interaction term with growth habit and year

mod2p_g_u <- lmer(avg_relative_abundance ~ state + insecticide + growth_habit + as.factor(year_factor)*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod2p_g_u)

mod3p_g_u <- lmer(avg_relative_abundance ~ state + growth_habit + as.factor(year_factor)*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod3p_g_u)

mod3p_g_u <- lmer(avg_relative_abundance ~ state + growth_habit + as.factor(year_factor)*growth_habit + (1|plot), umbs_growth_plot, REML = FALSE)
anova(mod3p_g_u)
mod3p_g_u <- lmer(avg_relative_abundance ~ state + insecticide + as.factor(year_factor) + growth_habit + (1|plot), umbs_growth_plot, REML=F)
mod4p_g_u <- lmer(avg_relative_abundance ~ state + growth_habit + (1|plot), umbs_growth_plot, REML=F)
mod5p_g_u <- lmer(avg_relative_abundance ~ state * growth_habit + (1|plot), umbs_growth_plot, REML=F)
mod6p_g_u <- lmer(avg_relative_abundance ~ state*growth_habit + insecticide*growth_habit + (1|plot), umbs_growth_plot, REML=F) # hypothesis?


AICtab(modfull_g_u, mod1p_g_u, mod2p_g_u, mod3p_g_u, mod4p_g_u, mod5p_g_u, mod6p_g_u, weights=T)
anova(mod2p_g_u, mod1p_g_u)
AICtab(mod2p_g_u, mod1p_g_u, weights=T)
anova(mod2p_g_u)
summary(mod2p_g_u)
plot_model(mod2p_g_u)

# with herb reduction as interactive term
anova(mod6p_g_u)

# code to get table information for manuscript
table <- anova(mod2p_g_u, mod6p_g_u)
kable(table) %>% kableExtra::kable_styling()
AICctab(mod2p_g_u, mod6p_g_u, weights=T)
```

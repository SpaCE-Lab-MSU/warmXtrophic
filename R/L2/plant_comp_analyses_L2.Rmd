...
# making a table
kable(anova(mod_k_full), digits = 2) %>% kableExtra::kable_styling()
...
# making a table
kable(anova(mod_native_k), digits = 2) %>% kableExtra::kable_styling()
...
# effect:
4.892777 - 5.265678 # effect of warming - warmed plots had -0.372901 or 0.37% less exotic species percent cover than ambient plots

# making a table
kable(anova(mod_exotic_k), digits = 2) %>% kableExtra::kable_styling()

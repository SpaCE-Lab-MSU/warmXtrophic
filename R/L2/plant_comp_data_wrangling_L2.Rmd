...
peak_comp1 <- peak_comp %>% 
        select(species, site, year_factor, month, date, year, julian, plot, cover, state, insecticide, treatment_key)
...
origin_peak_comp <- full_join(origin_peak_comp_umbs, origin_peak_comp_kbs, by = c("site", "year_factor", "month", "date", "year", "plot", "state", "insecticide", "treatment_key", "origin_cover_total", "plot_cover_total", "relative", "origin"))
write.csv(origin_peak_comp, file.path(L2_dir, "plant_composition/final_plant_comp_origin_L2.csv"), row.names = F)
...
growth_peak_comp <- full_join(growth_peak_comp_umbs, growth_peak_comp_kbs, by = c("site", "year_factor", "month", "date", "year", "plot", "state", "insecticide", "treatment_key", "growth_cover_total", "relative", "growth_habit"))
write.csv(growth_peak_comp, file.path(L2_dir, "plant_composition/final_plant_comp_growth_habit_L2.csv"), row.names = F)
```

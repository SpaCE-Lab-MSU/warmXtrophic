...
# Origin subsetting
# subset data to just include exotics
exotic_cover <- subset(peak_comp, origin == "Exotic")
write.csv(exotic_cover, file.path(L2_dir, "plant_composition/final_plant_comp_exotic_species_L2.csv"), row.names = F)
# subset data to just include natives
native_cover <- subset(peak_comp, origin == "Native")
write.csv(native_cover, file.path(L2_dir, "plant_composition/final_plant_comp_native_species_L2.csv"), row.names = F)

# Growth habit subsetting
# subset data to just include forbs
forb_cover <- subset(peak_comp, growth_habit == "Forb")
write.csv(forb_cover, file.path(L2_dir, "plant_composition/final_plant_comp_forb_species_L2.csv"), row.names = F)
# subset data to just include graminoid
graminoid_cover <- subset(peak_comp, growth_habit == "Graminoid")
write.csv(forb_cover, file.path(L2_dir, "plant_composition/final_plant_comp_graminoid_species_L2.csv"), row.names = F)
...
# Origin subsetting
# subset data to just include exotics
exotic_cover_plot <- subset(peak_comp, origin == "Exotic")
write.csv(exotic_cover_plot, file.path(L2_dir, "plant_composition/final_plant_comp_exotic_plot_L2.csv"), row.names = F)
# subset data to just include natives
native_cover_plot <- subset(peak_comp, origin == "Native")
write.csv(native_cover_plot, file.path(L2_dir, "plant_composition/final_plant_comp_native_plot_L2.csv"), row.names = F)
...
# Growth habit subsetting
# subset data to just include forbs
forb_cover_plot <- subset(peak_comp, growth_habit == "Forb")
write.csv(forb_cover_plot, file.path(L2_dir, "plant_composition/final_plant_comp_forb_plot_L2.csv"), row.names = F)
# subset data to just include graminoid
graminoid_cover <- subset(peak_comp, growth_habit == "Graminoid")
write.csv(forb_cover_plot, file.path(L2_dir, "plant_composition/final_plant_comp_graminoid_plot_L2.csv"), row.names = F)

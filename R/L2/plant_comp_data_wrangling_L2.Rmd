...
write.csv(peak_comp_plot, file.path(L2_dir, "plant_composition/final_plant_comp_plot_L2.csv"), row.names = F)
...
growth_peak_comp <- full_join(growth_peak_comp_umbs, growth_peak_comp_kbs, by = c("site", "year_factor", "month", "date", "year", "plot", "state", "insecticide", "treatment_key", "growth_cover_total", "relative", "absolute", "growth_habit"))

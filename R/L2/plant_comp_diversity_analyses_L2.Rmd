...
outlierTest(fit_state_kbs) # yes row 60 (2017), 148 (2021)
...
outlierTest(fit_state_umbs) # yes, row 190 and 202
...
# KBS State and year model
fit_stateyear_kbs_shannon <- lm(shannon ~ state + year, data = kbs_diversity)

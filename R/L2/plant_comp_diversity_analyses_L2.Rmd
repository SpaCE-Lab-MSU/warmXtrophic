...
```{r}
modfull_kr <- lmer(log(richness) ~ state*insecticide*year_factor + (1|plot), kbs_diversity, REML = FALSE)
...
# comparison 1
contrast1 <- contrast(emmeans(mod_kr, ~insecticide*year_factor), "pairwise", simple = "each", combine = F, adjust = "mvt")
...
# overall
exp((2.00924) +  (0.12440)*0) # 7.457647 
exp((2.00924) +  (0.12440)*1) # 8.445553
# effect:
8.445553 - 7.457647 # effect of warming - warmed plots had 0.987906 less species than ambient plots

# calculating effect size for herbivory and year - accounting for log transformation
# overall
exp((2.00924) +  (0.12440)*0) # 7.457647 
exp((2.00924) +  (0.12440)*1) # 8.445553
# effect:

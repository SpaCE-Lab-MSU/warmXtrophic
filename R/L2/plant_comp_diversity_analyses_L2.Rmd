...
comp_diversity <- comp_diversity[-c(135, 140, 142),] # remove this row with zero values for shannon diversity and species richness - this zero is from there not being any data in plot D5 in 2021 due to a large ground hog hole
...
shapiro.test(kbs_diversity$shannon) # pvalue is > 0.05 so we do not reject the null hypothesis that the data is normal (aka not normally distributed)

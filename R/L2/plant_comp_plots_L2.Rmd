...
plot_line_kbs_n <- plot_line_kbs_n + labs(title="KBS", y=NULL, subtitle = "Native") + theme(axis.text.x=element_blank())
plot_line_umbs_n <- plot_line_n("UMBS")
plot_line_umbs_n <- plot_line_umbs_n + labs(title="UMBS", y=NULL, subtitle = "Native") + theme(axis.text.x=element_blank())
...
png("origin_avg_percent_cover_plots_by_year_L2.png", units="in", width=9, height=8, res=300)
...
plot_line_gh <- ggpubr::ggarrange(plot_line_kbs_f, plot_line_umbs_f,
                          ...
                          nrow = 2, ncol = 2, common.legend = T, legend="right")
png("growth_habit_avg_percent_cover_plots_by_year_L2.png", units="in", width=9, height=8, res=300)

...
native_line_umbs <- native_line_umbs + labs(title="UMBS", subtitle= "Native", y=NULL) + theme(axis.text.x=element_blank())
...
exotic_line_kbs <- exotic_line_kbs + labs(title=NULL, subtitle="Exotic", y=NULL)
exotic_line_umbs <- exotic_line("umbs")
exotic_line_umbs <- exotic_line_umbs + labs(title=NULL, subtitle="Exotic", y=NULL)

origin_line <- ggpubr::ggarrange(native_line_kbs, native_line_umbs,
                                 exotic_line_kbs, exotic_line_umbs,
...
forb_line_umbs <- forb_line_umbs + labs(title="UMBS", subtitle= "Forb", y=NULL) + theme(axis.text.x=element_blank())
...
graminoid_line_kbs <- graminoid_line_kbs + labs(title=NULL, subtitle="Graminoid", y=NULL)
graminoid_line_umbs <- graminoid_line("umbs")
graminoid_line_umbs <- graminoid_line_umbs + labs(title=NULL, subtitle="Graminoid", y=NULL)

growthhabit_line <- ggpubr::ggarrange(forb_line_kbs, forb_line_umbs,
                                    graminoid_line_kbs, graminoid_line_umbs,
                          nrow = 2, ncol = 2, common.legend = T, legend="bottom")

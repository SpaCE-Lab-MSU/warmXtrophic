...
umbs_sd_plot_origin <- subset(umbs_sd_plot_origin, year != "2021") # delete 2021 data
umbs_sd_plot_growthhabit <- subset(sd_plot_growthhabit, site == "umbs")
umbs_sd_plot_growthhabit <- subset(umbs_sd_plot_growthhabit, year != "2021") # delete 2021 data
```

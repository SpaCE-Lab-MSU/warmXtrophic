...
#Merge data from all years 
KBS_3 <- rbind(KBS_3_2017, KBS_3_2018, KBS_3_2019, KBS_3_2020)
write.csv(KBS_3, file="L0/KBS/sensor_data/KBS_3.csv")

#Combine data from all years and all paired stations for KBS
KBS_allyears <- rbind(KBS_1_2017, KBS_1_2018, KBS_1_2019, KBS_1_2020, KBS_2_2017, KBS_2_2018, KBS_2_2019, KBS_2_2020, KBS_3_2017, KBS_3_2018, KBS_3_2019, KBS_3_2020)

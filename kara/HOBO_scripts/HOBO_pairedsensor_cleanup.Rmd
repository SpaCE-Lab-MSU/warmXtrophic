...
The U and H sensor data is then merged based on the date_time column. The 1516 dataframes do not have separate U and H files.
```{r}
############ KBS Pair 1
#Read in H
...
lapply is used to apply the necessary functions to the list. The functions can be found in the HOBO_functions.R script.
```{r}
#Apply functions

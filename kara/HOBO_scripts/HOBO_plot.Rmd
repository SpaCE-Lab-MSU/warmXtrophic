...
## Again, comparing PAR to HOBO, this time in line format - PAR in dashed lines
```{r, echo = FALSE, message=FALSE}
...
## Comparing PAR to HOBO for only 2019 because multiple PAR measurements were taken that year - PAR in dashed lines
```{r, echo = FALSE, message=FALSE}

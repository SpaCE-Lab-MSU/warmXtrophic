...
Page 8: UMBS linear regression between warmed temp and PAR  
Page 9: KBS soil temperature over time  
Page 10: KBS soil moisture over time  
Page 11: 1H sensor average air temperature by month over all years  
Page 12: 2H sensor average air temperature by month over all years  
Page 13: 3H sensor average air temperature by month over all years  
```{r, include = FALSE}

...
```
Guide  
Page 2: Yearly average air temperatures between KBS and UMBS  
Page 3: Monthly average air temperatures between KBS and UMBS for all years  
Page 4: Average July air temperatures between KBS and UMBS  
Page 5: Comparing PAR to HOBO between 2017-2019  
Page 6: Another comparison of PAR to HOBO from 2017-2019  
Page 7: Comparing PAR to HOBO for multiple 2019 dates & a Linear regression between 2019 warmed chamber PAR and HOBO  
Page 8: KBS soil temperature over time  
Page 9: KBS soil moisture over time  
Page 10: 1H sensor average air temperature by month over all years  
Page 11: 2H sensor average air temperature by month over all years  
Page 12: 3H sensor average air temperature by month over all years  
```{r, include = FALSE}
...
## Soil temperature over time - doesn't seem to be a difference between treatments
```{r, echo = FALSE, message=FALSE}
...
## Soil moisture over time - ambient retains more moisture
```{r, echo = FALSE, message=FALSE}

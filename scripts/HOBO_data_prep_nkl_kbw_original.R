...
summary(KBS_1H_2017)
tail(KBS_1H_2017)
KBS_1H_2018 <- read.csv("raw_data/KBS/sensor_data/2018/excel files from HOBOWARE/7_12_18/1H_0_071218.csv", skip=1)
str(KBS_1H_2018)
summary(KBS_1H_2018)
...
str(KBS_1U_2017)
summary(KBS_1U_2017)
KBS_1U_2018 <- read.csv("raw_data/KBS/sensor_data/2018/excel files from HOBOWARE/7_12_18/1U_0_071218.csv",skip=1)[ ,1:6]
head(KBS_1U_2018)
str(KBS_1U_2017)
summary(KBS_1U_2017)
...
str(KBS_2H_2017)
summary(KBS_2H_2017)
KBS_2H_2018 <- read.csv("raw_data/KBS/sensor_data/2018/excel files from HOBOWARE/7_12_18/2H_0_071218.csv", skip=1)
str(KBS_2H_2018)
summary(KBS_2H_2018)
...
str(KBS_2U_2017)
summary(KBS_2U_2017)
KBS_2U_2018 <- read.csv("raw_data/KBS/sensor_data/2018/excel files from HOBOWARE/7_12_18/2U_0_071218.csv",skip=1)[ ,1:6]
str(KBS_2U_2018)
summary(KBS_2U_2018)
...
str(KBS_3H_2017)
summary(KBS_3H_2017)
KBS_3H_2018 <- read.csv("raw_data/KBS/sensor_data/2018/excel files from HOBOWARE/7_12_18/3H_0_071218.csv", skip=1)
str(KBS_3H_2018)
summary(KBS_3H_2018)
...
str(KBS_3U_2017)
summary(KBS_3U_2017)
KBS_3U_2018 <- read.csv("raw_data/KBS/sensor_data/2018/excel files from HOBOWARE/7_12_18/3U_0_071218.csv",skip=1)[ ,1:6]
str(KBS_3U_2018)
summary(KBS_3U_2018)
...
UMBS_1H_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/8_22_18/8.22_UMBS_1H.csv", skip=1)
...
UMBS_1U_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/8_22_18/8.22_UMBS_1U.csv", skip=1)
...
UMBS_2H_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/8_22_18/8.22_UMBS_2H.csv", skip=1)
...
UMBS_2U_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/8_22_18/8.22_UMBS_2U.csv", skip=1)
...
UMBS_3H_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/8_22_18/8.22_UMBS_3H.csv", skip=1)
...
UMBS_3U_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/8_22_18/8.22_UMBS_3U_0.csv", skip=1)
...
save.image("HOBO_data_prep_nkl_kbw_original_8_31_18.RData")

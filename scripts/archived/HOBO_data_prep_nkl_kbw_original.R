...
summary(KBS_1H_2017)
tail(KBS_1H_2017)
KBS_1H_2018 <- read.csv("raw_data/KBS/sensor_data/2018/7_12_18 (stations)/1H_0_071218.csv", skip=1)
str(KBS_1H_2018)
summary(KBS_1H_2018)
...
str(KBS_1U_2017)
summary(KBS_1U_2017)
KBS_1U_2018 <- read.csv("raw_data/KBS/sensor_data/2018/7_12_18 (stations)/1U_0_071218.csv",skip=1)[ ,1:6]
head(KBS_1U_2018)
str(KBS_1U_2017)
summary(KBS_1U_2017)
...
str(KBS_2H_2017)
summary(KBS_2H_2017)
KBS_2H_2018 <- read.csv("raw_data/KBS/sensor_data/2018/7_12_18 (stations)/2H_0_071218.csv", skip=1)
str(KBS_2H_2018)
summary(KBS_2H_2018)
...
str(KBS_2U_2017)
summary(KBS_2U_2017)
KBS_2U_2018 <- read.csv("raw_data/KBS/sensor_data/2018/7_12_18 (stations)/2U_0_071218.csv",skip=1)[ ,1:6]
str(KBS_2U_2018)
summary(KBS_2U_2018)
...
str(KBS_3H_2017)
summary(KBS_3H_2017)
KBS_3H_2018 <- read.csv("raw_data/KBS/sensor_data/2018/7_12_18 (stations)/3H_0_071218.csv", skip=1)
str(KBS_3H_2018)
summary(KBS_3H_2018)
...
str(KBS_3U_2017)
summary(KBS_3U_2017)
KBS_3U_2018 <- read.csv("raw_data/KBS/sensor_data/2018/7_12_18 (stations)/3U_0_071218.csv",skip=1)[ ,1:6]
str(KBS_3U_2018)
summary(KBS_3U_2018)
...
UMBS_1H_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/9_19_18/UMBS_1H_91918.csv", skip=1)
...
UMBS_1U_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/9_19_18/UMBS_1U_91918.csv", skip=1)
...
UMBS_2H_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/9_19_18/UMBS_2H_91918.csv", skip=1)
...
UMBS_2U_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/9_19_18/UMBS_2U_91918.csv", skip=1)
...
UMBS_3H_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/9_19_18/UMBS_3H_91918.csv", skip=1)
...
UMBS_3U_2018b <- read.csv("raw_data/UMBS/sensor_data/2018/9_19_18/UMBS_3U_91918.csv", skip=1)
...
save.image("HOBO_data_prep_nkl_kbw_original_10_5_18.RData")

...
## Seeding
# This creates function so that you can look at a specific species at either kbs or umbs and it's mean julian day of first seed for every year of data collection
```{r}
...
## This creates a function that returns plots for a given site and year for average first date of seed comparing ambient vs warmed plots
```{r}
